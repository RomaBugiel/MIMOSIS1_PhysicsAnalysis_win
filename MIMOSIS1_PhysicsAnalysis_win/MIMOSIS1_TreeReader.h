...
public:
	...
	TString	get_scanned_parameter_name();

	//Variables
	TString _param_1;	//!< Name of first analysis parameter (default VPH). Used for input/output name generation.
	TString _param_2;	//!< Name of second analysis parameter (default VTH). Used for input/output name generation.
	TString _param_3;	//!< Name of third analysis parameter on default VBB). Used for input/output name generation.
	...
	TString _input_tree_file_path;		//!< Path to the input files.
	...
	TString _input_tree_file_name_core;
	TString _input_tree_name;			//!< Name of the input tree.
