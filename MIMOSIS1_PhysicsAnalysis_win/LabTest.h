...
class LabTest { 
	...
	public:
		...
		TString _scaned_param{""};	//!< Name of the scaned parameters.
	...
	private:
		...
		TString _output_tree_file_path 	{""};
		TString _output_tree_file_core  {""};
		TString _output_tree_file_part  {""};
		TString _output_tree_name 		{""};
